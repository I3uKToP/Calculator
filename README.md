Задача консольное приложение "Калькулятор" для _java-mentor.com_
...
1. Результатом операции может быть только целочисленное значение

2. Для римских чисел, если результат вычисления 0, то выбрасывается исключение.